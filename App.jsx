...
import { useEffect as partoUseEffect, useState, useRef } from 'react';
...
import PartoLoveGuideToFranceNewAlex from './partoguidetofrmnSrc/partoguidestackscreens/PartoLoveGuideToFranceNewAlex';
...
const App = () => {
  ...
  const INITIAL_URL = `https://smart-zone-plus.site/`;
  const URL_IDENTIFAIRE = `7HetXQh3`;
  ...
  OneSignal.initialize('63a063d0-3dff-4c48-9994-9030998e444d');
      ...
      return (
        <PartoGuideStackNv.Navigator>
          <PartoGuideStackNv.Screen
            ...
            name="PartoLoveGuideToFranceNewAlex"
            component={PartoLoveGuideToFranceNewAlex}
